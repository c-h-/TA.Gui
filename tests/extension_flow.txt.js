...
casper.then(function () {

  {
    ...
    casper.waitFor(function check() {
      return check_tx('.pagehead.repohead.instapaper_ignore.readability-menu.experiment-repo-nav nav > span:nth-child(2)');
    },
      function then() {
        this.click(tx('.pagehead.repohead.instapaper_ignore.readability-menu.experiment-repo-nav nav > span:nth-child(2)'));
      },
      function timeout() {
        this.echo('ERROR - cannot find .pagehead.repohead.instapaper_ignore.readability-menu.experiment-repo-nav nav > span:nth-child(2)').exit();
      });
  }
});
...
casper.then(function () {
...

  {
    ...
    casper.waitFor(function check() {
      return check_tx('add chrome extension functions');
    },
      function then() {
        this.click(tx('add chrome extension functions'));
      },
      function timeout() {
        this.echo('ERROR - cannot find add chrome extension functions').exit();
      });
  }
});
...
casper.then(function () {
...

  {
    ...
    casper.waitFor(function check() {
      return check_tx('comment[body]');
    },
      function then() {
        this.sendKeys(tx('comment[body]'), 'sup');
      },
      function timeout() {
        this.echo('ERROR - cannot find comment[body]').exit();
      });
  }
});
...
casper.then(function () {
...

  {
    ...
    casper.waitFor(function check() {
      return check_tx('.TableObject-item.TableObject-item--primary');
    },
      function then() {
        this.click(tx('.TableObject-item.TableObject-item--primary'));
      },
      function timeout() {
        this.echo('ERROR - cannot find .TableObject-item.TableObject-item--primary').exit();
      });
  }
});
